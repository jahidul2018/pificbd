		  ...
		  <div id="video-carousel-example2" class="carousel slide carousel-fade" data-ride="carousel">
			...
			<section class="">
					<div id="demo" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-item active">
							<img class="lazy" src="{{ asset('pific-web-site') }}/img/slider/mini/2-min.jpg" alt="Los Angeles" width="1100" height="460">
						</div>
						<div class="carousel-item">
							<img  class="lazy" src="{{ asset('pific-web-site') }}/img/slider/mini/3-min.jpg" alt="New York" width="1100" height="460">
						</div>
                        <div class="carousel-item">
							<img  class="lazy" src="{{ asset('pific-web-site') }}/img/slider/mini/4-min.jpg" alt="New York" width="1100" height="460">
						</div>
                        <div class="carousel-item">
							<img  class="lazy" src="{{ asset('pific-web-site') }}/img/slider/mini/5-min.jpg" alt="New York" width="1100" height="460">
						</div>
                        <div class="carousel-item">
							<img  class="lazy" src="{{ asset('pific-web-site') }}/img/slider/mini/6-min.jpg" alt="New York" width="1100" height="460">
						</div>
						</div>
