...
@section('content')
		...
		<!-- Breadcrumb -->
		<div class="breadcrumbs overlay" style="background-image:url('http://pific-bd.com/pific-web-site/img/team/team.png');">
			<div class="container">
				<div class="row">
					<div class="col-12">
        ...
        <section class="">
			<div class="container">
                <div class="row justify-content-center ">
                    <div class="about-content section-title default text-left section-space">
                            ...
                            <div class="card col-md-3 mt-100">
                                <div class="card-content">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-title">  Shobuz A. Ikbal<br /> <small>Chief Engineer/Team Leader</small> </div>
                            ...
                            <div class="card col-md-3 mt-100">
								<div class="card-content">
									<div class="card-body p-0">
										...
										<div class="card-title"> Kazi Hakimur Rashid<br /> <small>Senior Engineer/Deputy Team Leader</small> </div>
										<div class="card-subtitle">
							...
							<div class="card col-md-3 mt-100">
								<div class="card-content">
									<div class="card-body p-0">
										...
										<div class="card-title"> Md. Shamsur Rahman<br /> <small>Investment Officer</small> </div>
                                        <div class="card-subtitle">
                            ...
                            <div class="card col-md-3 mt-100 ">
                                <div class="card-content">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-title">Mohd.Shahjahan Ali<br /> <small> Civil Engineer </small> </div>
                                        <div class="card-subtitle">
                                            <p> <small class="text-muted"> Email : ce-pific@imcw-bangladesh.com </small> </p>
                                        </div>
                                        {{-- <div class="card-subtitle">
                            ...
                            <div class="card col-md-3 mt-100">
                                <div class="card-content">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-title"> Faisal Mahmud Mahedi<br /> <small>Junior Expert</small> </div>
                                        <div class="card-subtitle">
