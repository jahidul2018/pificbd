                    ...
                    <div class="bread-inner">
                        <div class="bread-menu">
                            <ul>
                                ...
                                <li><a href="about.html">GRM</a></li>
                            </ul>
                        </div>
                        <div class="bread-title"><h2>About GRM</h2></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row section-space">
                <div class="col-lg-5 offset-lg-1 col-md-6 col-12">
                    <div class="modern mb-4">
                        <img class="lazy" src="{{ asset('pific-web-site') }}/img/grm/grm.jpg" alt="About GRM">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="about-content section-title default text-left">
                        <div class="section-top section-title-2">
                            <h1><b>GRIEVANCE REDRESS MECHANISM
                            </b></h1>
                        </div>
                    ...
                    <div class="about-content section-title default text-left">
                        <div class="section-bottom section-title-2">
                            <div class="text">
                                ...
                                <p>
                                    <p> <b>Focal point : </b> Kazi Hakimur Rashid, Deputy Team Leader, PIFIC MU </p>
                                    <a href="tel:+8801712291172"> <p> Contact: 	Phone +88 01712291172</p></a> <a href="mailto:info@pific.com"><p>Email: dtl-pific@imcw-bangladesh.com</p></a>
                                </p>
                            </div>
                        </div>
                    </div>
