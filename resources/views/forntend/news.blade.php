    ...
    <!-- Breadcrumb -->
						...
						<div class="bread-inner">
							...
							<div class="bread-menu">
								<ul>
									...
									<li><a href="blog-grid.html">News&Event</a></li>
								</ul>
							</div>
							<!-- Bread Title -->
		...
		<section class="blog-layout news-default section-space">
			<div class="container">
                ...
                <div class="row ml-2">
                    <div class="bread-inner">
                        <div class="bread-title"><h1><span> NewsPaper Coverage</span>  </h1></div>
                    </div>
                </div>
				<div class="row ">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news ">
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href=""> $40m fund to create 90,000 new job</a></h3>
									<div class="news-text"><p></p></div>
									{{-- <a href="blog-single.html" class="more">Continue reading <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> --}}
								</div>
							</div>
				    ...
				    <div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news ">
							<div class="news-head overlay">
								<img class="lazy" src="{{ asset('pific-web-site') }}/img/news/paper-cut/4.jpg" alt="#">
								<ul class="news-meta">
									<li class="author"><a href="#"><i class="fa fa-user"></i>site</a></li>
									<li class="date"><i class="fa fa-calendar"></i>December 09, 2020</li>
									<li class="view"><i class="fa fa-comments"></i>0</li>
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href="">Press Conference At ERF With MOC</a></h3>
									<div class="news-text"><p></p></div>
									{{-- <a href="blog-single.html" class="more">Continue reading <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> --}}
								</div>
							</div>
				    ...
				    <div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news ">
							<div class="news-head overlay">
								<img class="lazy" src="{{ asset('pific-web-site') }}/img/news/paper-cut/5.jpg" alt="#">
								<ul class="news-meta">
									<li class="author"><a href="#"><i class="fa fa-user"></i>site</a></li>
									<li class="date"><i class="fa fa-calendar"></i>December 09, 2020</li>
									<li class="view"><i class="fa fa-comments"></i>0</li>
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href="">Govt To Spend $40m For 4 Sectors</a></h3>
									<div class="news-text"><p></p></div>
									{{-- <a href="blog-single.html" class="more">Continue reading <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> --}}
								</div>
							</div>
				    ...
				    <div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news ">
							<div class="news-head overlay">
								<img class="lazy" src="{{ asset('pific-web-site') }}/img/news/paper-cut/6.jpg" alt="#">
								<ul class="news-meta">
									<li class="author"><a href="#"><i class="fa fa-user"></i>site</a></li>
									<li class="date"><i class="fa fa-calendar"></i>December 09, 2020</li>
									<li class="view"><i class="fa fa-comments"></i>0</li>
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href="">Export Competitiveness For Jobs Project</a></h3>
									<div class="news-text"><p></p></div>
									{{-- <a href="blog-single.html" class="more">Continue reading <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> --}}
								</div>
							</div>
                ...
                <div class="row ">
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news ">
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href="#">PIFIC Workshop</a></h3>
									<div class="news-text"><p>Workshop at rajshahi </p></div>
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news ">
							...
							<div class="news-body">
								<div class="news-content">
									<h3 class="news-title"><a href="blog-single.html"> PIFIC Meeting </a></h3>
