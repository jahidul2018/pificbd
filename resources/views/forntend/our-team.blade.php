...
@section('content')
		...
		<!-- Breadcrumb -->
		<div class="breadcrumbs" style="background-image:url('http://pificbd.syssolution.com.bd/pific-web-site/img/team/team.png')">
			<div class="container">
				<div class="row">
					<div class="col-12">
                            ...
                            <div class="card col-md-3 mt-100">
								<div class="card-content">
									<div class="card-body p-0">
										...
										<div class="card-title"> Kazi Hakimur Rashid<br /> <small>MS Civil Engineering,FIEB/Deputy Team Leader</small> </div>
										<div class="card-subtitle">
