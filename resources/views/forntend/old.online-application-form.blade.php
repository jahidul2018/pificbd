                    ...
                    <div class="panel panel-primary setup-content" id="step-1">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadios3">
                                Light Engineering
                                [ Sub-Sectors: Electronics & Electrical Goods /Accumulators
/Automobiles and Parts /Foundries /Bicycles /Dies & Molds]
                                </label>
                            </div>
                                <div class="form-group">
                    ...
                    <div class="panel panel-primary setup-content" id="step-6">
                        ...
                        <div class="panel-body">
                            ...
                            <button class="btn btn-success " type="submit" id="butsave"><a href="{{ asset('pific-web-site') }}/Project-Application.docx" target="_blank" rel="noopener noreferrer"></a> Download Complete Form</button>
                         </div>
                    </div>
                </form>
            </div>
